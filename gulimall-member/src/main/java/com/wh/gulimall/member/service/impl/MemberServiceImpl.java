package com.wh.gulimall.member.service.impl;
...
import com.wh.gulimall.member.dao.MemberLevelDao;
...
import com.wh.gulimall.member.dao.MemberDao;
...
public class MemberServiceImpl extends ServiceImpl<MemberDao, MemberEntity> implements MemberService {
    ...
    //社交登录
    @Override
    public MemberEntity auth2login(SocialUser socialUser) throws Exception {
        //具有登录和注册逻辑
